...
function createListing(title, description, price, isbn, conditionId, pictureUrl, cb) {
  ...
  if (url.pathname === '/list') {
    ...
    req.on('end', function() {
      try {
        ...
        createListing(title, description, price, isbn, conditionId, data.pictureUrl || '', function(result) {
          res.writeHead(200);
